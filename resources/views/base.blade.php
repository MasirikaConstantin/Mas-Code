...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark  fixed-top py-1  shadow-lg p-3 mb-5 bg-dark " style="opacity: .9" aria-label="Ninth navbar example">
    <div class="container-xl">
      <a class="navbar-brand" href="{{route('index')}}" style="font-size:30px" >
      <img src="{{asset('mas product.png')}}" width="80px" height="70px" alt="" srcset="">
        {{__("mon-site")}}
...
@endphp
      ...
      <div class="collapse navbar-collapse" id="navbarsExample07XL">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a @class(['nav-link', 'active'=>str_contains($route, 'index')])  aria-current="page" href="{{route('index')}}">Accueil</a>
          </li>
          @if (str_contains($route, 'user'))
          <li class="nav-item">
            <a @class(['nav-link', 'active'=>str_contains($route, 'newpost')])  href="{{route('user.newpost')}}">Post</a>
          </li>
          @endif

          <li class="nav-item">
            <!--//href="{{route('blog.index')}}"-->
            <a @class(['nav-link', 'active'=>str_contains($route, 'blog.')])  >Blog</a>
          </li>
          <li class="nav-item">
            <a @class(['nav-link', 'active'=>str_contains($route, 'user.')]) href="{{route('user.accueil')}}" >Forum</a>
          </li>
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          @auth
          <li>
            <a  class="nav-link text-white  me-2"> {{Auth::user()->name}} </a>
            </li>
          @endauth
          ...
          <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            ...
            @auth
              ...
              <ul class="dropdown-menu text-small " aria-labelledby="dropdownUser1">
                  ...
                  <li><a class="dropdown-item" href="{{route('user.newpost')}}">Nouveau Post</a></li>
              ...
              <ul class="nav" >
                <li class="nav-item me-2 " ><a class="bouto" href="{{route('register')}}" style="text-decoration: none !important" > <i class="bi bi-person-plus s"></i>  Créer un compte</a></li>
                <li class="nav-item" ><a class="bouto" href="{{route('login')}}"  style="text-decoration: none !important" >    <i class="bi bi-person s"></i>  Se Connecter</a></li>
              </ul>
              @endguest
...
<div class="contadiner  accs" style=" " >
    @endif
      <div class="col-md-12">
...
<h1 class="mt-5">@yield('section','Bienvenu')   </h1>
...
<div class="container">
  <footer class="py-5">
    ...
    <div class="d-flex justify-content-between py-4 my-4 border-top">
      ...
      <div class="py-5 mt-5 linear-g-w" >
...
Bienvenue sur <a href="/" style="font-size: 25px" >{{__("mon-site")}}</a>  ! Nous sommes une plateforme en ligne dédiée à fournir des réponses claires et précises à vos questions, quelle que soit leur domaine. 
...
<button type="button" class="btn btn-link" data-bs-toggle="modal" data-bs-target="#exampleModals">
  Lire plus
</button>
  ...
  <div class="modal-dialog  modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body ">
        ...
        <p>Bienvenue sur <a href="" style="font-size: 25px" >{{__("mon-site")}}</a> ! Nous sommes une plateforme en ligne dédiée à fournir des réponses claires et précises à vos questions, quelle que soit leur domaine. 
        ...
        <p>Que vous soyez à la recherche de réponses, que vous souhaitiez partager vos connaissances ou simplement explorer de nouveaux sujets, nous vous invitons à rejoindre notre communauté dynamique. Posez des questions, répondez aux autres, et contribuez à faire de <strong>{{__("mon-site")}}</strong> une ressource précieuse pour tous.</p>
          ...
          <small>République Démocratique du Congo, Kinshasa</small>
            ...
            <div class="col-md-3 col-sm-12 col-12">
              ...
              <div class="mb-3">
                ...
                <div wire:id="ONwhpxoWbK7iT94laIM4" wire:initial-data="{&quot;fingerprint&quot;:{&quot;id&quot;:&quot;ONwhpxoWbK7iT94laIM4&quot;,&quot;name&quot;:&quot;user.form.registration-newsletter&quot;,&quot;locale&quot;:&quot;fr&quot;,&quot;path&quot;:&quot;\/&quot;,&quot;method&quot;:&quot;GET&quot;,&quot;v&quot;:&quot;acj&quot;},&quot;effects&quot;:{&quot;listeners&quot;:[]},&quot;serverMemo&quot;:{&quot;children&quot;:[],&quot;errors&quot;:[],&quot;htmlHash&quot;:&quot;2a2c9e44&quot;,&quot;data&quot;:{&quot;email&quot;:null,&quot;user&quot;:null,&quot;type&quot;:0},&quot;dataMeta&quot;:[],&quot;checksum&quot;:&quot;3c4c30fdb6d6c744154d2219513d0419d91a97f1b5a1c673553ff25a347fa133&quot;}}"  >
