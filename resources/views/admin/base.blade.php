...
<div class="container py-2">
  <header>
    <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
      <a href="{{route('admin.dashboard')}}" class="d-flex align-items-center link-body-emphasis text-decoration-none">
      ...
      <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        ...
        <form method="POST" class="py-2 link-body-emphasis text-decoration-none" action="{{ route('admin.logout') }}">
          @csrf
      
          <x-dropdown-link class="btn btn-outline-danger" :href="route('admin.logout')"
...
<main class="flex-shrink-0">
    ...
    <div class="container">
  <h1 class="mt-1">@yield('section','Bienvenu')   </h1>
